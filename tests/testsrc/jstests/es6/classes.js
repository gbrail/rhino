...
(function TestBasics() {
  ...
  var E = class {}
  // TODO assertEquals('E', E.name);

  var F = class { constructor() {} };
  // TODO assertEquals('F', F.name);

  var literal = { E: class {} };
  // TODO assertEquals('E', literal.E.name);

  literal = { E: class F {} };
  // TODO assertEquals('F', literal.E.name);

  /* TODO dunno this syntax 
  literal = { __proto__: class {} };
  // TODO assertEquals('', literal.__proto__.name);
