...
/**
 * This array supports atomic and regular operations on a BigUint64 array for a shared array buffer.
 */
public class NativeSharedBigUint64Array extends NativeBigUint64Array {
    ...
    public NativeSharedBigUint64Array(NativeArrayBuffer ab, int off, int len) {
        super(ab, off, len);
